    ...
    <div class="bg-white rounded-lg shadow-xl max-w-lg w-full mx-4 relative">
      ...
      <div class="px-6 pb-6 text-center">
        ...
        <p class="text-gray-600 text-sm leading-relaxed">
          This short quiz helps us understand your starting point before the
          lesson begins. Don't worry — it's not for marks. Just try your best.
          Your results will help guide your learning and show how much progress
          you make.
        </p>
      </div>
...
const startQuiz = () => {
  ...
  const substrandRoute =
    props.substrandRoute || "substrand-number-and-numeration-system";
  const strandId = props.strandId || "1";
  navigateTo(
    props.route ||
      "/learning-modules/assignment_workbook1/strand-" +
        strandId +
        "/" +
        "substrand-" +
        substrandRoute +
