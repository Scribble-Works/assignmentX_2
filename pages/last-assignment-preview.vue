      ...
      <!-- <v-carousel hide-delimiters height="950"> -->
        <!-- <v-carousel-item v-for="(img, index) in previewImages" :key="index"> -->
          <div class="h-full w-full flex justify-center items-center">
            <iframe height="650" width="900" src="https://yvzftzhtqcddqadufjue.supabase.co/storage/v1/object/public/book-preview/last%20Assignment%202025%20first%2030%20pages.pdf" frameborder="0"></iframe>
            <!-- <img
              :src="img"
              alt="Preview"
