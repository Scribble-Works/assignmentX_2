    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      <div class="h-full w-full flex justify-center items-center">
        <iframe
          height="650"
          width="900"
          src="https://yvzftzhtqcddqadufjue.supabase.co/storage/v1/object/public/book-preview/last%20Assignment%202025%20first%2030%20pages.pdf"
          allow-scripts
          allow-same-origin
          frameborder="0"
        ></iframe>
