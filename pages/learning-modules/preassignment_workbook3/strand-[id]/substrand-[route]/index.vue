...
const startQuiz = (contentId) => {
  ...
  navigateTo(
    `/learning-modules/preassignment_workbook3/strand-${strand_ref_id}/substrand-${substrand_ref}/quiz/${substrand_ref_id}?contentId=${contentId}`,
  );
};
...
const handleContentClick = (contentId) => {
  ...
  if (isQuizCompletedForTopic) {
    ...
    navigateTo(
      `/learning-modules/preassignment_workbook3/strand-${strand_ref_id}/${substrandRoute}/${contentId}`,
    );
  } else {
