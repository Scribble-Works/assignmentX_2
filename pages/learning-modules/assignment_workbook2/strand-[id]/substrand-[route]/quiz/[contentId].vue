...
const goToContent = () => {
  ...
  router.push(
    `/learning-modules/assignment_workbook2/strand-${strandId}/substrand-${substrandRoute}/${targetContentId}`,
  );
};
...
const goBackToSubstrand = () => {
  ...
  router.push(
    `/learning-modules/assignment_workbook2/strand-${strandId}/substrand-${substrandRoute}`,
  );
};
