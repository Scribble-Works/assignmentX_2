...
// Course completion toggle function for checkbox
...
const goBackToSubstrand = () => {
  ...
  navigateTo(
    `/learning-modules/preassignment_workbook1/strand-${strand_ref_id}/${substrandRoute}`,
  );
};
</script>
<template>
  <div class="body">
    <v-container>
      ...
      <div class="mt-15">
        ...
        >
          Worked
          <span style="position: relative; text-decoration: none">
            Examples
            <svg
              style="
                position: absolute;
        ...
        <v-container
          style="background-color: #f3f4f6; min-height: 800px; padding: 3rem"
        >
          <!-- Fun Activity Image -->
          <div class="mb-6">
            <v-img
      ...
      <div class="mt-10">
        <h3
          class="text-h3 mb-10 font-weight-bold"
        ...
        <v-container style="background-color: #f3f4f6">
          <div class="mt-10">
            ...
            <div class="text-center mb-4">
              <p
                class="text-body-1"
                style="color: #666; max-width: 600px; margin: 0 auto"
              >
                Click on the card below to reveal the answer to the math
                equation. Try to solve it in your head first, then flip to check
                your answer!
              </p>
            </div>
      ...
      <div class="mt-15">
        <div class="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          >
            ...
            <p class="text-gray-600 mb-6">
              Congratulations! You've successfully completed this course. You
              can now return to the course list or continue with other topics.
            </p>
