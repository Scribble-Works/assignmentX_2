...
const { data: unsortedStrands } = await client.from('pre-assignment_Workbook1').select();
...
<template>
    <div class="body">
        <v-container>
            <introvid :intro="'https://www.youtube.com/embed/stWOvMPHD3E'" />
            <br>
            <h2 class="text-h3">Welcome to Your Math Companion!</h2><br>
            <p style="width: 100%;">Not every explanation in the textbook will make sense right away, and that’s okay.
            ...
            <div class="mt-10">
                <v-row v-for="strand in strands" :key="strand.id">
                    <v-col cols=12>
                        <NuxtLink :to="'/learning-modules/preassignment_workbook2/strand-' + strand.id + '/'">
