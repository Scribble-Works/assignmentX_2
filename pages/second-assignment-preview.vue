    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="text-left mb-16">
        ...
        <p className="text-sm text-slate-600 max-w-4xl ">
          ...
          the Assignment Maths Workbooks brings math to life through real-world
          examples, storytelling, and guided practice.
        </p>
      </div>

      <!-- Carousel -->
      <!-- <v-carousel hide-delimiters height="950"> -->
      <!-- <v-carousel-item v-for="(img, index) in previewImages" :key="index"> -->
      <div class="h-full w-full flex justify-center items-center">
        <iframe
          height="650"
          width="900"
          src="https://yvzftzhtqcddqadufjue.supabase.co/storage/v1/object/public/book-preview/Second%20Assignment%202025%20first%2030%20pages.pdf"
          allow-scripts
          allow-same-origin
          frameborder="0"
        ></iframe>
        <!-- <img
              :src="img"
              alt="Preview"
              class="h-[800px] w-auto rounded-l shadow-lg object-contain"
            /> -->
      </div>
      <!-- </v-carousel-item> -->
      <!-- </v-carousel> -->
