...
const testimonials = [
  {
    quote:
      "At first glance, you do not need a second look to tell you the material is excellent. The content is exhaustive, the arrangement is meticulous and the standard is second to none. A very impressive effort.",
    author: "Baldwin Lamptey",
    school: "Maths Teacher Day Spring Montessori Int. Sch, Dansoman",
  },
  {
    quote:
      "At first glance, you do not need a second look to tell you the material is excellent. The content is exhaustive, the arrangement is meticulous and the standard is second to none. A very impressive effort.",
  ...
  <div class="body">
    ...
    <v-container>
      <v-row>
        ...
        <v-col cols="" lg="" md="" sm="12">
          <h4 class="text-h4">
            <span style="color: #fcc30c; font-weight: bold">AssignmentX</span>
            is a learning platform built to help students truly understand
            mathematics, not just memorize it.
          </h4>
          <br />
          <p>
      ...
      <v-row class="mt-16">
        ...
        <v-col cols="" lg="6" sm="12" md="6" class="mt-10">
          <h4 class="text-h3">
            The AssignmentX <span style="color: #4c9f38">Mission</span>
          </h4>
          <br />
          <p>
          ...
          <p>
            we help them build a deep understanding and achieve skill mastery
            and innovation. Our platform is also a resource for teachers,
            helping them create effective and differentiated content.
          </p>
        </v-col>
      </v-row>
      <v-row class="mt-15">
        <v-col cols="" lg="6" sm="12" md="6">
          <h4 class="text-h4">
            Our Learning <span style="color: #fcc30c">Approach</span>
          </h4>
          <br />
          <p>
          ...
          <v-row>
            ...
            <v-col lg="9" md="9" sm="8" class="mt-5">
              ...
              <p>
                Explore the story, purpose, and real-world value of each math
                concept.
              </p>
            </v-col>
          </v-row>
          <v-row>
            ...
            <v-col lg="9" md="9" sm="8" class="mt-5">
              ...
              <p>
                Learn step-by-step through videos, notes, games, and worked
                examples.
              </p>
            </v-col>
          </v-row>
