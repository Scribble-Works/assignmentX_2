...
const conceptNote3 = strand3Contents[0].fields.concept_notes;
const bece3 = strand3Contents[0].fields.bece_questions;

function openNotes(){
    navigateTo(conceptNote3, {
        open:{
            windowFeatures:{
                width: 500,
                height: 500,
        ...
        <v-container>
            ...
            <v-row>
                <v-col cols="auto" lg="8" sm="6" md="6">
                    <iframe height="80%" width="100%" :src="conceptNote3" frameborder="0"
